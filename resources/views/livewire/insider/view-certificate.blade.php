        ...
        @if ($certificate)
            ...
            <div
                ...
                <div class="text-center space-y-4">
                    ...
                    <p class="text-lg sm:text-xl text-gray-900 dark:text-white">
                        ประเภท:
                        {{ $insider && $insider->insider_role ? ($insider->insider_role === 'academic' ? 'บุคลากรสายวิชาการ' : ($insider->insider_role === 'teaching' ? 'บุคลากรสายการสอน' : 'ไม่ระบุ')) : 'ไม่ระบุ' }}
                    </p>
                    <p class="text-lg sm:text-xl text-gray-900 dark:text-white">
            ...
            <!-- Back Button -->
            <div class="mt-6">
                <a href="{{ route('my-certificates-insider') }}"
